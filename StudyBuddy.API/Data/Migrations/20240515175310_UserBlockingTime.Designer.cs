...
namespace StudyBuddy.API.Data.Migrations
{
    ...
    [Migration("20240515175310_UserBlockingTime")]
    partial class UserBlockingTime
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudyBuddy.Shared.Models.Block", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("StudyBuddy.Shared.Models.SystemBlock", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("SystemBlockReasonId")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("SystemBlockReasonId");

                    b.ToTable("SystemBlocks");
                });

            modelBuilder.Entity("StudyBuddy.Shared.Models.SystemBlockReason", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("StudyBuddy.Shared.Models.Block", b =>
                {
                    b.HasOne("StudyBuddy.Shared.Models.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StudyBuddy.Shared.Models.User", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("StudyBuddy.Shared.Models.SystemBlock", b =>
                {
                    b.HasOne("StudyBuddy.Shared.Models.User", "BlockedUser")
                        .WithMany()
                        .HasForeignKey("BlockedUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StudyBuddy.Shared.Models.SystemBlockReason", "SystemBlockReason")
                        .WithMany()
                        .HasForeignKey("SystemBlockReasonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BlockedUser");

                    b.Navigation("SystemBlockReason");
                });
